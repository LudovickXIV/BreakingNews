...
public class ArticleViewedListFragment extends BaseFragment implements SwipeRefreshLayout.OnRefreshListener {
    ...
    protected void getData() {
        Call<NYTimesRequest> call = retrofitService.getViewed();
