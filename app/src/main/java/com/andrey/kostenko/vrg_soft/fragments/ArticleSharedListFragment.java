...
public class ArticleSharedListFragment extends BaseFragment implements SwipeRefreshLayout.OnRefreshListener {
    ...
    protected void getData() {
        Call<NYTimesRequest> call = retrofitService.getShared();
